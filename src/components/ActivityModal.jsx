...
export default function ActivityModal({ activity, lang, t, onClose }) {
  ...
  // Trigger exit animations, then unmount after they complete.
  const handleClose = () => {
    setClosing(true)
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* ── CTA buttons ─────────────────────────────────────────── */}
        <div className="px-6 py-5 grid grid-cols-2 gap-3 border-t border-gray-100 flex-shrink-0 bg-white">
          <a
